...
List<PlayingCard> cards = [
  // 2
  PlayingCard(title: '2', level: 2, suit: Suit.hearts),
  ...
  // 3
  PlayingCard(title: '3', level: 3, suit: Suit.hearts),
  ...
  // 4
  PlayingCard(title: '4', level: 4, suit: Suit.hearts),
  ...
  // 5
  PlayingCard(title: '5', level: 5, suit: Suit.hearts),
  ...
  // 6
  PlayingCard(title: '6', level: 6, suit: Suit.hearts),
  ...
  // 7
  PlayingCard(title: '7', level: 7, suit: Suit.hearts),
  ...
  // 8
  PlayingCard(title: '8', level: 8, suit: Suit.hearts),
  ...
  // 9
  PlayingCard(title: '9', level: 9, suit: Suit.hearts),
  ...
  // 10
  PlayingCard(title: '10', level: 10, suit: Suit.hearts),
  ...
  // J
  PlayingCard(title: 'J', level: 11, suit: Suit.hearts),
  ...
  // Q
  PlayingCard(title: 'Q', level: 12, suit: Suit.hearts),
  ...
  // K
  PlayingCard(title: 'K', level: 13, suit: Suit.hearts),
  ...
  // A
  PlayingCard(title: 'A', level: 14, suit: Suit.hearts),
